...
//	bulletBatchNode->addChild(bullet);
	...
	Point planePosition = PlaneLayer::sharedPlane->getChildByTag(747)->getPosition();
	Point bulletPosition = Point(planePosition.x, planePosition.y+PlaneLayer::sharedPlane->getChildByTag(747)->getContentSize().height/2);
